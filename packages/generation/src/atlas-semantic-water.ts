/** Version-1 marine clearance, basin/sea segmentation, and connectivity analysis. */

import { type AtlasOceanConnectivity, fingerprintAtlasSurfaceComponent } from '@ttrpg-map/core';
