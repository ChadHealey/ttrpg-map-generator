...
const PREFIX = 'docs/investigations/issue-188/';
const FIXED = [
  'sources.mjs',
  'run.mjs',
  'design.md',
...
export function stageEntry(stage) {
  assert.equal(stage, 'components', 'Only the complete two-fixture capture is permitted');
  return `${PREFIX}fixtures.mjs`;
}
