...
| Simplification   | Project-owned topology-guarded vertex removal in an unwrapped local chart                                                                                                                                                                                    | Can rank removable vertices deterministically, retain seam/pole and inherited anchors, and accept a removal only after exact quantized intersection/containment checks. It rejects rather than silently collapsing a channel or island.                                                          | No dependency. #60 must version tolerance, candidate ordering, tie-breaking, and full nesting validation.                                                                                                                    | **Selected family; production implementation deferred to #60.**                                                         |
