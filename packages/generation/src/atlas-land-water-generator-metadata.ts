/** Versioned ownership, compatibility, cost, and tolerance metadata for atlas land/water. */
...
import {
  ATLAS_SEPARATED_FIELD_BEHAVIOR_VERSION,
  ATLAS_SEPARATED_FIELD_GAP_POLICY_VERSION,
  ATLAS_SEPARATED_FIELD_MINIMUM_OCEAN_GAP_RAD,
  ATLAS_SEPARATED_FIELD_PLACEMENT_BUDGET,
  ATLAS_SEPARATED_FIELD_SHAPE_POLICY_VERSION,
...
export const ATLAS_LAND_WATER_GENERATOR_MANIFEST_VERSION = 2 as const;
...
export const ATLAS_LAND_WATER_DIAGNOSTIC_CODES = Object.freeze({
  ...
  macroGapUnsatisfied: diagnosticCode('atlas.macro-v2.gap-unsatisfied'),
  macroOwnerShapeUnsatisfied: diagnosticCode('atlas.macro-v2.owner-shape-unsatisfied'),
...
interface AtlasManifestAspect {
  ...
  readonly additionalBehaviorVersion: 1 | 2;
  ...
  readonly randomDrawPolicy: 'finite-basis-parameters' | 'finite-separated-owners' | 'zero-draws';
}

/** Complete machine-readable v2 ownership, compatibility, cost, and tolerance declaration. */
export const ATLAS_LAND_WATER_GENERATOR_MANIFEST = Object.freeze({
  ...
  versions: Object.freeze({
    ...
    fieldBehaviorVersion: ATLAS_SEPARATED_FIELD_BEHAVIOR_VERSION,
  ...
  tolerances: Object.freeze({
    ...
    minimumOwnerOceanGapRad: ATLAS_SEPARATED_FIELD_MINIMUM_OCEAN_GAP_RAD,
  }),
  expectedCost: Object.freeze({
    ...
    macroPlacementBudget: ATLAS_SEPARATED_FIELD_PLACEMENT_BUDGET,
  }),
...
function aspectManifest(
  ...
  const macroVersion = selectAtlasMacroElevationVersion(2);
  return Object.freeze({
    ...
    parameterSchemaVersion: ATLAS_LAND_WATER_PARAMETER_SCHEMA_VERSION,
    additionalBehaviorVersion:
      kind === 'worldTerrain.macroElevation' ? ATLAS_SEPARATED_FIELD_BEHAVIOR_VERSION : 1,
    ...
    randomDrawPolicy:
      kind === 'worldTerrain.macroElevation'
        ? ('finite-separated-owners' as const)
        : ('zero-draws' as const),
  });
}
