...
import { excludesWedgeSegment, wedgeFunctions } from '../issue-176/wedge-segment.mjs';

const SPHERE = 4 * Math.PI;
export const SUPPORTING_CHART_LIMIT = 1.4;

/** Called only after positive-role certification and exact whole-body/pocket topology. */
export function certifyWholeBodyMouth(
  candidate,
  ...
  return {
    ...
    acceptance: 'whole-body-water-wedge-and-lambert-lower-bounds',
    openingLower,
    openingUpper,
    depthLower,
