...
export {
  ...
  ATLAS_SVG_LABEL_EXPORT_PROFILE_ID,
  ATLAS_SVG_LABEL_EXPORT_VERSION,
  ...
  type AtlasSvgLabelExport,
  type AtlasSvgLabelExportProgress,
  type AtlasSvgLabelExportResult,
  type AtlasSvgLabelExportRuntime,
...
export {
  ...
  ATLAS_VECTOR_LABEL_MAXIMUM_GLYPH_INSTANCES,
  ATLAS_VECTOR_LABEL_MAXIMUM_NODES,
  ATLAS_VECTOR_LABEL_MAXIMUM_STORED_POINTS,
  type AtlasVectorGlyphDefinition,
  type AtlasVectorGlyphInstance,
  type AtlasVectorLabelCompositionResult,
  type AtlasVectorLabelDiagnostic,
  type AtlasVectorLabelLayer,
  type AtlasVectorLabelNode,
  type AtlasVectorLabelValidationResult,
  composeAtlasVectorLabelLayer,
  expandAtlasVectorLabelLayer,
  expandAtlasVectorLabelNode,
