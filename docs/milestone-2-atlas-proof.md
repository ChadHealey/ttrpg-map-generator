...
| -------------------------------------------- | -------------------------------------- | ---------------------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `worldTerrain.macroElevation`                | `worldTerrain.macroElevation`          | world-surface singleton      | none                                                                                                              | field versions 1 and 2       | Quantized macro elevation and matching generator/field provenance. Invalidated by circumference, continent-count intent, continent distribution, fragmentation, island abundance, archipelago abundance, or polar character. |
